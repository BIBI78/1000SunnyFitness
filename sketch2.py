...
### this where im currently working on the activity factor bit 
# need to figure out how to incopate the number of days the user chooses to workout into the new cal per day 
