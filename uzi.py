...
###PROBLEME###
# activyt factor not displaying 
# scheudles are not displaying either #
...
def weight_change(user_info):
    ...
    if weight_change == "lose":
        ...
        print(f"You should eat about {round(recommended_deficit)} calories per day for about {round(days_needed)} days")
...
# THIS AND THE ACTIVYT FCTOR DONT PRINT
